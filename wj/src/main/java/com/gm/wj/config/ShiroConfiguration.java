...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/api/book/favorite", "authc");
        filterChainDefinitionMap.put("/api/book/unfavorite", "authc");
        filterChainDefinitionMap.put("/api/book/favorites", "authc");
        filterChainDefinitionMap.put("/api/book/favorite/ids", "anon");
        filterChainDefinitionMap.put("/api/book/isFavorite/**", "anon");
